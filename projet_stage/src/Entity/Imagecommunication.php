 ...
 * Imagecommunication
 *
 * @ORM\Table(name="imagecommunication", indexes={@ORM\Index(name="messagerie", columns={"messagerie"}), @ORM\Index(name="tchat", columns={"tchat"}), @ORM\Index(name="com", columns={"com"})})
 * @ORM\Entity
 */
